...
![Donation Button placed at bottom of page](effectivegiving.github.io/img/donatemoved.jpeg) As a result, we chose to move our donation button above the charity's contact information but below the text about the charity to make it easier to find while still encouraging users to learn about the charity first. 
